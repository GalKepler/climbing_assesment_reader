...
app = typer.Typer(
    name="climbing_assessment_reader",
...
def version_callback(print_version: bool) -> None:
    ...
    if print_version:
        console.print(
            f"[yellow]climbing_assessment_reader[/] version: [bold blue]{version}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    print_version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the climbing_assessment_reader package.",
    ),
) -> None:
